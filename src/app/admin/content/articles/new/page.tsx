...
export default function NewArticlePage() {
  ...
  const handleSaveAndNavigate = async () => {
    ...
    // Note: handleSave navigates on success
  };
  ...
  const handleSave = async (status: "draft" | "published") => {
    ...
    try {
      const res = await fetch("/api/admin/collections/articles/entries", {
        method: "POST",
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="bg-white border border-zinc-200 rounded-xl p-4 lg:p-6 shadow-sm">
        <button
