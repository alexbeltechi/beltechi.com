...
const socialLinks = [
  {
    name: "X (Twitter)",
    href: "https://x.com/AlexBeltechi",
    icon: XIcon,
  },
  {
    name: "YouTube",
    href: "https://www.youtube.com/alexbeltechi",
    icon: YouTubeIcon,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/beltechi/",
    icon: LinkedInIcon,
  },
  {
    name: "Instagram",
    href: "http://instagram.com/alexbeltechi",
    icon: InstagramIcon,
  },
  {
    name: "Pinterest",
    href: "http://pinterest.com/beltechiarchive",
    icon: PinterestIcon,
  },
  {
    name: "WhatsApp",
    href: "https://wa.me/40746842839",
    icon: WhatsAppIcon,
  },
];
